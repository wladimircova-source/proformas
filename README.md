...
<body class="p-4 md:p-8">
    ...
    <!-- Vista de Panel Administrativo (No se muestra en la impresión) -->
                    ...
                    <div class="border-t border-gray-800 pt-3">
                        ...
                        <div id="items-container" class="space-y-2">
                            <div class="flex gap-1 item-row">
                                ...
                                <input type="text" placeholder="Descripción del artículo o servicio" class="flex-1 input-field rounded p-1 text-xs item-desc" required>
    ...
    <!-- VISTA IMPRIMIBLE (Oculta en entorno web, solo visible en Impresión/PDF) -->
    <div id="print-area" class="hidden print-view max-w-4xl mx-auto p-6 bg-white text-black text-sm">
        
        <!-- Título Dinámico Gigante Corregido -->
        <div class="mb-4">
            <h1 id="p-documento-titulo-grande" class="text-4xl font-black tracking-tight text-gray-900 uppercase">DOCUMENTO</h1>
        </div>
        ...
        <!-- Tabla de artículos/servicios para el cliente -->
    ...
    <!-- Inicialización de Firebase Cloud y Control de Flujo -->
    <script type="module">
        import { initializeApp } from "https://www.gstatic.com/firebasejs/10.8.0/firebase-app.js";
        import { getFirestore, collection, addDoc, onSnapshot, query, orderBy } from "https://www.gstatic.com/firebasejs/10.8.0/firebase-firestore.js";

        // Credenciales Oficiales de tu Base de Datos
        ...
        // Añadir una nueva fila de artículo en el panel de control
        ...
        // Sumar subtotales del formulario de forma automática
        ...
        // Carga y ordenamiento en tiempo real desde Firestore
        ...
        // Almacenar el documento asignando el código correlativo correcto
        window.guardarDocumento = async function(e) {
            e.preventDefault();
            const tipo = document.getElementById('tipo_doc').value;
            
            // Contabilizamos los existentes del mismo tipo para subir el índice
        ...
        // Estructuración dinámica del PDF corporativo e impresión limpia sin cabeceras web rotas
        window.imprimirDocumentoLocal = function(id) {
            const d = listaDocumentos.find(doc => doc.id === id);
            if(!d) return;

            // Cambiar los títulos dinámicamente según la selección (Presupuesto / Proforma / Nota de Entrega)
            const nombreTipo = d.tipo === 'NOTA_ENTREGA' ? 'NOTA DE ENTREGA' : d.tipo;
            document.getElementById('p-documento-titulo-grande').innerText = nombreTipo;
            document.getElementById('p-badge-tipo').innerText = nombreTipo;
